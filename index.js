const {
  ...
  const ownerNumber = ['923005448162']
...
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
    if (config.SESSION_ID && config.SESSION_ID.trim() !== "") {
        const sessdata = config.SESSION_ID.replace("SARWAR-MD~", '');
        try {
...
const port = process.env.PORT || 9090;
  ...
  const conn = makeWASocket({
    ...
    if (connection === 'close') {
      ...
      let up = `*HELLO THERE SARWAR-MD USER*

> *sɪᴍᴘʟᴇ sᴛʀᴀɪɢʜᴛ ғᴏʀᴡᴀʀᴅ ʙᴜᴛ ʟᴏᴀᴅᴇᴅ ᴡɪᴛʜ ғᴇᴀᴛᴜʀᴇs 🎊 ᴍᴇᴇᴛ sᴀʀᴡᴀʀ-ᴀʟɪ-ᴍᴅ ᴡʜᴀᴛsᴀᴘᴘ ʙᴏᴛ*

- *THANKS FOR USING SARWAR-MD 🚩*
...
https://github.com/ayanali7860/SARWAR-ALI-MD

> © ᴘᴏᴡᴇʀᴇᴅ ʙʏ sᴀʀᴡᴀʀ-ᴀʟɪ-ᴍᴅ-ᴍᴅ 🍨`;
...
const Adeel = ['923005448162','923242895504'] 
const dev = [] 
...
if (senderNumber.includes("923005448162") && !isReact) {
